...
export const STAFF_STATUS_FAILURE = 'STAFF_STATUS_FAILURE'

export const STAFF_EDITOR_OPEN = 'STAFF_EDITOR_OPEN'
export const STAFF_EDITOR_CLOSE = 'STAFF_EDITOR_CLOSE'